...
/** Unix seconds for Chicago local time on `year-month-day` at `hour` (0–23). */
...
/**
 * Chart bucket open — epoch buckets for intraday, Chicago calendar for `1D`/`1W`/`1M`.
 *
 * @param {number} unixSec
 * @param {number|string} resolutionOrPeriod — minutes as number, or `"1D"` / `"1W"` / `"1M"`
 */
