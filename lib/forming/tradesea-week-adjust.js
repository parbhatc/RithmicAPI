...
/**
 * @param {number} nativeFridayWeekClose ΓÇö Rithmic native weekly bar close (Friday marker)
 * @param {object} [options] ΓÇö passed to `fetchTradeSeaClosedWeekClose`
...
/**
 * @param {string} resolution ΓÇö e.g. `"240"`, `"1W"`
 * @param {object} [options]
